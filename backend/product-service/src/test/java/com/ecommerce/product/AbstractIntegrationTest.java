...
public abstract class AbstractIntegrationTest {
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("db.password", () -> "test"); // In case it's used elsewhere

        // Override file storage location for tests
        registry.add("app.file-storage.location", () -> "target/uploads");
    }
}
